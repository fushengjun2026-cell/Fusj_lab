...
function newGame(){clearSave();grid=emptyGrid();score=0;history=[];gameOver=false;addTile();addTile();draw();setMessage("Use the arrow keys, buttons, or swipe to begin.")}
...
if(loadGame()){draw();setMessage(gameOver?"The board is full. Undo a move to continue.":"Welcome back — your orbit is restored.")}else{newGame()}
